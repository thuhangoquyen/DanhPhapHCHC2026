...
function HomePage() {
  ...
  useEffect(() => {
    const dataToLearn =
      selectedChapter === "Tất cả"
        ? fullData
        : fullData.filter((item) => item.chapter === selectedChapter);
  ...
  const startQuiz = (scope: "11" | "12" | "all") => {
    ...
    const generatedQuestions = Array.from({ length: 100 }).map(() => {
      const correctItem =
        dataToQuiz[Math.floor(Math.random() * dataToQuiz.length)];
      const wrongOptions = dataToQuiz
        .filter((item) => item.id !== correctItem.id)
        .sort(() => 0.5 - Math.random())
        .slice(0, 3);
      const options = [correctItem, ...wrongOptions].sort(
        () => 0.5 - Math.random()
      );
      const questionType =
        Math.random() > 0.5 ? "name2formula" : "formula2name";
  ...
  const getRanking = () => {
    if (correctCount >= 15)
      return {
        title: "Thủ khoa Hoá Học",
        icon: "🎓",
        color: "#f1c40f",
        desc: "Giáo sư tương lai đây rồi! Tốc độ bàn thờ!",
      };
    if (correctCount >= 10)
      return {
        title: "Chiến thần Danh pháp",
        icon: "🌟",
        color: "#3498db",
        desc: "Phản xạ xuất thần! Rất đáng khen!",
      };
    if (correctCount >= 5)
      return {
        title: "Tân binh Hữu cơ",
        icon: "🧪",
        color: "#e67e22",
        desc: "Mới khởi động thôi, làm lại để cháy hơn nhé!",
      };
    return {
      title: "Chúa tể mất gốc",
      icon: "📚",
      color: "#e74c3c",
      desc: "Đùa chút thôi! Hãy qua tab Học tập ôn lại nhé!",
    };
  };
        ...
        <div style={{ animation: "fadeIn 0.3s" }}>
          <div style={{ display: "flex", gap: "10px", marginBottom: "15px" }}>
            <button
              ...
              style={{
                ...
                borderRadius: "10px",
                border: "none",
                backgroundColor: activeGrade === "11" ? "#3498db" : "#f1f2f6",
                color: activeGrade === "11" ? "white" : "#7f8c8d",
                fontWeight: "bold",
                cursor: "pointer",
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "10px",
                border: "none",
                backgroundColor: activeGrade === "12" ? "#e74c3c" : "#f1f2f6",
                color: activeGrade === "12" ? "white" : "#7f8c8d",
                fontWeight: "bold",
                cursor: "pointer",
              }}
            >
          ...
          >
            <button
              ...
              style={{
                ...
                border: "none",
                backgroundColor:
                  learningMode === "f2n" ? "#fff" : "transparent",
                color: learningMode === "f2n" ? "#3498db" : "#7f8c8d",
                fontWeight: "bold",
                boxShadow:
                  learningMode === "f2n" ? "0 2px 5px rgba(0,0,0,0.1)" : "none",
                cursor: "pointer",
              }}
            >
              Công thức ➔ Tên
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                backgroundColor:
                  learningMode === "n2f" ? "#fff" : "transparent",
                color: learningMode === "n2f" ? "#3498db" : "#7f8c8d",
                fontWeight: "bold",
                boxShadow:
                  learningMode === "n2f" ? "0 2px 5px rgba(0,0,0,0.1)" : "none",
                cursor: "pointer",
              }}
            >
              Tên ➔ Công thức
          ...
          {learningQueue.length > 0 ? (
            ...
            >
              ...
              >
                <MolecularFlashcard
                  key={`${learningQueue[0].id}-${actionCount}`}
                  compound={learningQueue[0]}
                  mode={learningMode}
                  onFlipStateChange={setIsActionLocked}
                />
              </div>
          ...
          {quizStatus === "idle" && (
            <div>
              <div style={{ textAlign: "center", marginBottom: "20px" }}>
                ...
                >
                  ĐẤU TRƯỜNG 60 GIÂY ⏱️
                </h3>
                <p style={{ color: "#7f8c8d", fontSize: "13px", margin: 0 }}>
                  Chọn phạm vi để bắt đầu thử thách cực hạn!
                </p>
                <div
                  style={{
                    marginTop: "10px",
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            alignItems: "center",
                            padding: "12px",
                            backgroundColor: isTop3 ? bgColors[idx] : "#fff",
                            borderRadius: "10px",
                            borderBottom: `2px solid ${
                              isTop3 ? borderColors[idx] : "#eee"
                            }`,
                          }}
                        >
                          <div
            ...
            >
              ...
              >
                ...
                >
                  <span
                    style={{
                      backgroundColor: timeLeft <= 10 ? "#e74c3c" : "#3498db",
                      color: "#fff",
                      padding: "5px 12px",
                      borderRadius: "15px",
                      fontSize: "16px",
              ...
              >
                ...
                >
                  {quizQuestions[currentQIndex].questionType === "name2formula"
                    ? "Công thức của chất này là gì?"
                    : "Tên gọi của chất này là gì?"}
                </p>

                {quizQuestions[currentQIndex].questionType ===
                "name2formula" ? (
                  <h3 style={{ fontSize: "22px", color: "#2c3e50", margin: 0 }}>
                    {quizQuestions[currentQIndex].correctItem.nameIUPAC}
                  </h3>
                ) : (
                  <div
                    style={{
                  ...
                  >
                    <FormulaDisplay
                      compound={quizQuestions[currentQIndex].correctItem}
                      isOption={false}
                    />
                  </div>
                )}
              ...
              >
                {quizQuestions[currentQIndex].options.map(
                  (opt: any, index: number) => {
                    const isSelected = selectedAnswer === opt.id;
                    const isCorrectAnswer =
                      opt.id === quizQuestions[currentQIndex].correctItem.id;
                    let bgColor = "#f1f2f6";
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {quizQuestions[currentQIndex].questionType ===
                          "name2formula" ? (
                            <FormulaDisplay compound={opt} isOption={true} />
                          ) : (
                            opt.nameIUPAC
                          )}
                        </span>
          ...
          {quizStatus === "finished" && (
            <div
              style={{
                ...
                boxShadow: "0 10px 25px rgba(241, 196, 15, 0.2)",
              }}
            >
              ...
              <div
                style={{
                  display: "inline-block",
                  backgroundColor: getRanking().color,
                  color: "#fff",
                  padding: "5px 15px",
                  borderRadius: "20px",
                  fontSize: "14px",
              ...
              {score > 0 && !isScoreSaved ? (
                ...
                isScoreSaved && (
                  ...
                  >
                    ✅ Đã lưu kỷ lục của bạn vào Bảng vàng!
                  </div>
                )
              )}
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <button
                  onClick={() => {
                    if (currentQuizScope) startQuiz(currentQuizScope);
                  }}
                  style={{
                    flex: 2,
                    padding: "15px",
